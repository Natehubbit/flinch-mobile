...
var Drawer = function (props) {
    ...
    var isCeleb = user.celebrity.isCeleb;
    var onToggleSwitch = function (val) {
        setToggle(val);
        dispatch(user_1.userActions.switchUserRole());
        reset({
            index: 0,
    ...
    return react_1["default"].createElement(react_native_1.View, { style: styles.drawer },
        react_1["default"].createElement(react_native_1.View, { style: styles.head },
            ...
            react_1["default"].createElement(react_native_1.View, null, isCeleb && react_1["default"].createElement(react_native_paper_1.Switch, { theme: { colors: { accent: 'white' } }, value: toggle, onValueChange: function (val) { return onToggleSwitch(val); } }))),
        renderRoutes(),
