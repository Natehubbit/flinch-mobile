...
var Navbar = function (_a) {
  var title = _a.title,
    ...
    hideBell = _a.hideBell,
    edit = _a.edit,
    showCancel = _a.showCancel,
    invert = _a.invert,
    onCancel = _a.onCancel,
    onEdit = _a.onEdit
  var _b = native_1.useNavigation(),
    navigate = _b.navigate,
    canGoBack = _b.canGoBack,
    dispatch = _b.dispatch,
    goBack = _b.goBack
  var showBadge = useNotifications_1['default']()
    .showBadge
  ...
  var onToggleDrawer = function () {
    return dispatch(
      native_1.DrawerActions.toggleDrawer()
    )
  }
  var onSearch = function () {
    return navigate('Search')
  }
  var renderIcon = function (icon, badge) {
  ...
  return react_1['default'].createElement(
    react_native_paper_1.Appbar,
    {
      theme: {
        colors: { primary: theme_1.COLORS.white }
      },
      style: [
        styles.container,
        barStyle && barStyle
    ...
    backable && showBack
      ? react_1[
          ...
          react_native_paper_1.Appbar.BackAction,
          { color: iconColor, onPress: goBack }
        )
      : !hideMenu &&
          react_1['default'].createElement(
    ...
    react_1['default'].createElement(
      react_native_paper_1.Appbar.Content,
      {
        title: title,
    ...
    isHome &&
      react_1['default'].createElement(
        react_native_paper_1.Appbar.Action,
        {
          icon: function () {
            return renderIcon('magnify')
          },
          onPress: onSearch,
          animated: false,
          color: iconColor
    ...
    edit &&
      ...
      react_1['default'].createElement(
        ...
        {
          icon: function () {
            return renderIcon('account-edit')
          },
          onPress: onEdit,
          color: iconColor
        }
...
exports[
  'default'
] = react_native_paper_1.withTheme(Navbar)
