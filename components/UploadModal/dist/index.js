...
var UploadModal = function () {
  ...
  var _a = react_1.useState(0),
    progress = _a[0],
    setProgress = _a[1]
  var _b = useLoader_1.useLoader().responseLoader,
    label = _b.label,
    showBtns = _b.showBtns,
    type = _b.type
  react_1.useEffect(
    function () {
      var unsubscribe =
        UploadHookService_1['default']
          .uploadHookRef &&
        UploadHookService_1['default'].listen(
          setProgress,
          onUploadError
        )
      return function () {
  ...
  return react_1['default'].createElement(
    ...
    isProgress
      ? react_1['default'].createElement(
          react_native_paper_1.ProgressBar,
          {
            progress: progress,
