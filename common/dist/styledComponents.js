...
exports.maxWidth = react_native_1.Dimensions.get(
  'window'
).width
exports.maxHeight = react_native_1.Dimensions.get(
  'window'
).height
exports.AuthContainer = native_1[
  'default'
].ScrollView(
  templateObject_1 ||
...
exports.AuthContainer2 = native_1['default'].View(
  templateObject_2 ||
...
exports.Paragraph = native_1['default'].Text(
  templateObject_4 ||
...
exports.FormContainer = native_1['default'].View(
  templateObject_5 ||
...
exports.FlexContainer = native_1['default'].View(
  templateObject_6 ||
...
exports.MainTitle = native_1['default'].Text(
  templateObject_7 ||
...
exports.SubHeading = native_1['default'].Text(
  templateObject_8 ||
...
exports.MainLabel = native_1['default'].Text(
  templateObject_9 ||
...
exports.AltMainLabel = native_1['default'].Text(
  templateObject_10 ||
...
exports.MiniLabel = native_1['default'].Text(
  templateObject_11 ||
...
exports.AltMiniLabel = native_1['default'].Text(
  templateObject_12 ||
