...
var getAllRequests = function (id) { return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
...
var reloadRequests = function (id, callback) { return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, RequestService_1["default"].getAllRequests(id)];
            case 1:
                res = _a.sent();
                res && dispatch(exports.actions.getRequests(res));
                callback && callback();
