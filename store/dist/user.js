    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 8:
                _c;
                userData &&
                    dispatch(exports.actions.getUser(__assign(__assign({ id: '', displayName: '', email: '', imageUrl: '', role: 'user', loggedIn: true, profileUpdated: true }, userData), { token: token || {
                            data: '',
                            type: 'expo'
                        } })));
...
var signup = function (password, data, callback) { return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
    var user, token, hasImage, blob, uri, _a, userData, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                dispatch(loader_1.loaderActions.loading('authLoader'));
                return [4 /*yield*/, AuthService_1["default"].signUp(data.email, password)];
            case 1:
                user = _c.sent();
                return [4 /*yield*/, NotificationService_1["default"].getToken()];
            case 2:
                ...
                if (!hasImage) return [3 /*break*/, 8];
                return [4 /*yield*/, HelperService_1["default"]
                        .parseToBlob(data.imageUrl)];
            case 3:
                blob = _c.sent();
                _a = blob && !!user.id;
                if (!_a) return [3 /*break*/, 5];
                return [4 /*yield*/, HelperService_1["default"]
                        .generateBlobUrl("user/" + user.id, blob)];
            case 4:
                _a = (_c.sent());
                _c.label = 5;
            case 5:
                ...
                return [4 /*yield*/, UserService_1["default"]
                        .addUser(__assign(__assign(__assign({}, user), data), { celebrity: {
                            id: '',
                            isCeleb: false
                        }, imageUrl: uri || '', token: token }))];
            case 6:
                _b = (_c.sent());
                _c.label = 7;
            case 7:
                userData = _b;
                userData &&
                    dispatch(exports.actions.getUser(__assign(__assign({}, userData), { profileUpdated: true, token: token || '', loggedIn: true })));
                _c.label = 8;
            case 8:
                callback && callback();
                dispatch(loader_1.loaderActions.loaded('authLoader'));
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, AuthService_1["default"].login(mail, pass)];
            case 4:
                auth = _d.sent();
                _b = auth;
                if (!_b) return [3 /*break*/, 6];
                return [4 /*yield*/, AuthService_1["default"].updateAuthEmail(data.email)];
            case 5:
                _b = (_d.sent());
                _d.label = 6;
            case 6:
                ...
                _c = updated;
                if (!_c) return [3 /*break*/, 8];
                return [4 /*yield*/, UserService_1["default"].update(data)];
            case 7:
                _c = (_d.sent());
                _d.label = 8;
            case 8:
                user = _c;
                user &&
                    dispatch(exports.actions.getUser(__assign(__assign({}, user), { profileUpdated: true })));
                return [3 /*break*/, 11];
            case 9: return [4 /*yield*/, UserService_1["default"].update(data)];
            case 10:
                updated = _d.sent();
                updated &&
                    dispatch(exports.actions.getUser(__assign(__assign({}, updated), { profileUpdated: true })));
                _d.label = 11;
            case 11:
                dispatch(loader_1.loaderActions.loaded('authLoader'));
                return [2 /*return*/];
...
var switchUserRole = function () { return function (dispatch, getState) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                if (data) {
                    dispatch(resetApp());
                    dispatch(exports.actions.getUser(__assign(__assign({}, data), { role: 'user' })));
                }
                _b.label = 4;
