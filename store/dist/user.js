...
_a).actions),
  (exports.userSlice = __rest(_a, ['actions']))
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                AuthService_1['default'].signout()
              ]
            case 1:
              isSignedOut = _a.sent()
              isSignedOut &&
                dispatch(resetApp(true))
              dispatch(
                loader_1.loaderActions.loaded(
                  'authLoader'
                )
...
var resetApp = function (clearUser) {
  return function (dispatch) {
    clearUser &&
      dispatch(exports.userActions.clearUser())
    dispatch(
      loader_1.loaderActions.resetLoaders()
    )
    dispatch(
      notifications_1.notificationsActions.clearNotifications()
    )
    dispatch(celebs_1.celebsActions.clearCelebs())
    dispatch(
      request_1.requestActions.clearRequest()
    )
    dispatch(
      requests_1.requestsActions.clearRequests()
    )
  }
}
