...
var Profile = function () {
  ...
  var _d = react_1.useState(''),
    password = _d[0],
    setPassword = _d[1]
  var _e = react_native_1.useWindowDimensions(),
    height = _e.height,
    width = _e.width
  var route = native_1.useRoute().name
  var _f = useUser_1.useUser(),
    id = _f.id,
    imageUrl = _f.imageUrl,
    name = _f.displayName,
    email = _f.email
  var _g = react_1.useState(editting ? name : ''),
    userName = _g[0],
    setUserName = _g[1]
  ...
  var onUpdateImg = function () {
    HelperService_1['default'].uploadPhoto(
      setImgUri
    )
  }
  var onSave = function () {
