...
var Video = function () {
  ...
  var _b = react_1.useState(0),
    progress = _b[0],
    setProgress = _b[1]
  var displayName = useUser_1.useUser()
    .displayName
  ...
  var onShare = function () {
    HelperService_1['default'].shareMedia(
      displayName +
        ' sent you a FLINCH from ' +
        name +
        ' at ' +
        url
    )
  }
  var onSaveVideo = function () {
    return __awaiter(
      void 0,
      void 0,
      void 0,
