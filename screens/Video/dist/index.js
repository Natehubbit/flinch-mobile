        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    setSaving(true);
                    label = Date.now() + '.mp4';
                    return [4 /*yield*/, DownloadHookService_1["default"].download(url, label + ".mp4", setProgress)];
                case 1:
                    uri = _b.sent();
                    _a = uri;
                    if (!_a) return [3 /*break*/, 3];
                    return [4 /*yield*/, HelperService_1["default"].saveMedia(constants_1.VIDEO_SAVES, uri)];
                case 2:
                    _a = (_b.sent());
                    _b.label = 3;
                case 3:
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: [styles.container] },
        ...
        react_1["default"].createElement(react_native_1.View, { style: [styles.videoContainer] },
            ...
            react_1["default"].createElement(expo_linear_gradient_1.LinearGradient, { colors: [
                ...
                react_1["default"].createElement(react_native_1.View, { style: [styles.btns] }, !saving ? (react_1["default"].createElement(react_native_paper_1.FAB, { icon: "cloud-download", onPress: onSaveVideo, label: "Download", theme: {
                        colors: {
                            accent: 'transparent'
                        }
                    }, uppercase: false, style: [styles.download] })) : (react_1["default"].createElement(react_native_paper_1.FAB, { icon: null, loading: saving, label: progress + "% Downloading", uppercase: false, small: true, style: [styles.download] }))),
