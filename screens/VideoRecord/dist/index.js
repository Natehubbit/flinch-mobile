...
var timerId = null;
var VideoRecord = function (_a) {
    var navigation = _a.navigation;
    var camera = react_1.useRef(null);
    var dispatch = react_redux_1.useDispatch();
    var toast = useToast_1.useToast();
    var _b = react_1.useState(null), info = _b[0], setInfo = _b[1];
    var id = native_1.useRoute().params.id;
    var _c = react_1.useState(false), isRecording = _c[0], setIsRecording = _c[1];
    var _d = react_1.useState(true), showInstructions = _d[0], setShowInstructions = _d[1];
    var _e = react_1.useState('16:9'), ratio = _e[0], setRatio = _e[1];
    var _f = react_1.useState(false), isPreviewing = _f[0], setIsPreviewing = _f[1];
    var _g = react_1.useState(''), videoUri = _g[0], setVideoUri = _g[1];
    var _h = react_1.useState(61), timer = _h[0], setTimer = _h[1];
    var _j = react_1.useState(expo_camera_1.Camera.Constants.Type.front), cameraView = _j[0], setCameraView = _j[1];
    var _k = react_1.useState(false), showControls = _k[0], setShowControls = _k[1];
    var goBack = native_1.useNavigation().goBack;
    var _l = info || { instructions: '', recipient: '' }, instructions = _l.instructions, recipient = _l.recipient;
    ...
    var onSend = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            dispatch(toast_1.toastActions.setToast(__assign(__assign({}, toast), { show: false })));
            send();
            return [2 /*return*/];
        });
    }); };
    var onCameraReady = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setCameraRatio()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var send = function () {
        ...
        dispatch(requests_1.requestsActions.approveRequest(id, videoUri, callback));
    };
    var getRequestData = function () { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, RequestService_1["default"].getRequest(id)];
                case 1:
                    data = _a.sent();
                    data && setInfo({
    ...
    var setCameraRatio = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!camera.current) return [3 /*break*/, 2];
                    return [4 /*yield*/, camera
                            .current
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: styles.container },
        react_1["default"].createElement(react_native_1.View, { style: styles.nav },
            isRecording || isPreviewing ? null : (react_1["default"].createElement(react_native_paper_1.FAB, { icon: "arrow-left", style: styles.icon, small: true, onPress: onGoBack })),
            ...
            !showInstructions &&
                !isPreviewing &&
                !isRecording && (react_1["default"].createElement(react_native_paper_1.FAB, { icon: "eye-outline", style: [styles.showIcon], small: true, onPress: onShowInstructions }))),
        !isPreviewing && (react_1["default"].createElement(react_native_1.View, { style: styles.camera },
            ...
            react_1["default"].createElement(expo_camera_1.Camera, { onCameraReady: onCameraReady, style: [styles.cameraModule], type: cameraView, ref: camera, ratio: ratio }))),
        isPreviewing && (react_1["default"].createElement(react_native_1.View, { style: styles.videoContainer },
            ...
            !showControls && (react_1["default"].createElement(react_native_paper_1.FAB, { icon: "refresh", style: styles.save, label: "Record again", small: true, onPress: onRecordAgain })))),
        react_1["default"].createElement(react_native_1.View, { style: styles.content },
            !isRecording && !isPreviewing && (react_1["default"].createElement(react_native_1.View, { style: [styles.recordContainer] },
