...
var RECORD_OPTIONS = {
  ...
  maxDuration: 60,
  quality:
    expo_camera_1.Camera.Constants.VideoQuality[
      '480p'
    ]
}
var timerId = null
var VideoRecord = function () {
  ...
  var _b = react_1.useState(true),
    showInstructions = _b[0],
    setShowInstructions = _b[1]
  var _c = react_1.useState('16:9'),
    ratio = _c[0],
    setRatio = _c[1]
  var _d = react_1.useState(false),
    isPreviewing = _d[0],
    setIsPreviewing = _d[1]
  var _e = react_1.useState(''),
    videoUri = _e[0],
    setVideoUri = _e[1]
  var _f = react_1.useState(61),
    timer = _f[0],
    setTimer = _f[1]
  ...
  var _h = react_1.useState(false),
    showControls = _h[0],
    setShowControls = _h[1]
  var goBack = native_1.useNavigation().goBack
  var _j =
      useRequests_1.useRequests('id', id)[0] ||
      constants_1.initStateRequest,
    instructions = _j.instructions,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              resetTimer()
              setIsRecording(true)
              promise = camera.current.recordAsync(
                RECORD_OPTIONS
              )
              startTimer()
  ...
  var onSend = function () {
    return __awaiter(
      ...
      function () {
        return __generator(this, function (_a) {
          dispatch(
            toast_1.toastActions.setToast(
              __assign(__assign({}, toast), {
                show: false,
                onPress: send
              })
            )
