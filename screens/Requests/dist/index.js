...
var Requests = function () {
  ...
  var key =
    name === 'Pending'
      ...
      ? 'success'
      : ''
  var requests = useRequests_1.useRequests(
    'status',
    key
  )
  ...
  var _a = react_1.useState(false),
    refresh = _a[0],
    setRefresh = _a[1]
  var loading = useLoader_1.useLoader()
    .requestsLoader.isLoading
  react_1.useEffect(function () {
    fetchData()
  }, [])
  var fetchData = function () {
    dispatch(
      requests_1.requestsActions.getAllRequests()
    )
  }
  var onReload = function () {
    ...
    dispatch(
      requests_1.requestsActions.reloadRequests(
        endRefresh
      )
    )
  }
  var onOpenRequest = function (id, data) {
            ...
            renderItem: function (_a) {
              ...
              return react_1[
                ...
                RequestCard_1['default'],
                {
                  ...
                  imageUrl:
                    item.celebrity.imageUrl,
                  price: HelperService_1[
                    'default'
