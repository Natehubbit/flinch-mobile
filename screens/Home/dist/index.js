...
var Home = function () {
  ...
  var celebsLoader = useLoader_1.useLoader()
    .celebsLoader.isLoading
    ...
    return (
      ...
      celebs.map(function (celeb) {
        return react_1['default'].createElement(
          CelebImage_1['default'],
          __assign({ key: celeb.id }, celeb, {
            large: true
          })
        )
      })
  ...
  return react_1['default'].createElement(
    ...
    null,
    react_1['default'].createElement(
      styledComponents_1.AppContainer,
      {
