...
var CelebHome = function () {
  ...
  react_1.useEffect(function () {
    dispatch(
      requests_1.requestsActions.listenForPending(
        setRequests,
        setUnsubscribe
      )
    )
    ...
    react_1['default'].createElement(
      react_native_1.ScrollView,
      {
        refreshControl: react_1[
          ...
          {
            refreshing: loading,
            colors: [theme_1.theme.colors.primary]
          }
        )
      },
      react_1['default'].createElement(
          ...
          react_1['default'].createElement(
            ...
            requests.map(function (req) {
              return react_1[
                ...
                CelebRequestCard_1['default'],
                {
                  ocassion: req.occasion,
                  price: HelperService_1[
                    'default'
                  ].parseToMoney(req.price),
