...
var Search = function () {
    var _a = native_1.useNavigation(), goBack = _a.goBack, navigate = _a.navigate;
    var onClose = function () { return goBack(); };
    var onPress = function (data) {
        navigate('Celeb', { data: data });
    };
    return react_1["default"].createElement(react_native_1.View, { style: styles.container },
        react_1["default"].createElement(react_instantsearch_core_1.InstantSearch, { searchClient: SearchService_1["default"].searchClient, indexName: "celebs" },
            react_1["default"].createElement(SearchBox_1["default"], null),
            react_1["default"].createElement(SearchHits_1["default"], { onPress: onPress })),
