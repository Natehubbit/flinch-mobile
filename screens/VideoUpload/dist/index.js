...
var VideoUpload = function (_a) {
    ...
    var onUploadVideo = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, HelperService_1["default"].uploadVideo(setVideoUri)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var send = function () {
        dispatch(requests_1.requestsActions.approveRequest(id, videoUri, onReset));
    };
