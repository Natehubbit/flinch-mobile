...
var UploadHookService = /** @class */ (function () {
  ...
  UploadHookService.listen = function (
    setProgress,
    onError,
    onComplete
  ) {
    ...
    return this.uploadHookRef.on(
      firebase_1['default'].storage.TaskEvent
        .STATE_CHANGED,
      function (snap) {
        return _this.next(snap, setProgress)
      },
      function (e) {
        return _this.error(e, onError, reset)
      },
      function () {
        return _this.complete(onComplete)
      }
    )
  }
  ...
  UploadHookService.next = function (
    snapshot,
    setProgress
  ) {
    var progress =
  ...
  UploadHookService.error = function (
    error,
    reset,
    onError
  ) {
