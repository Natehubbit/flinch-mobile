...
var VID_OPTIONS = {
  ...
  videoMaxDuration:
    constants_1.RECORD_DURATION * 1000
}
var HelperService = /** @class */ (function () {
  ...
  HelperService.uploadVideo = function (
    getVideo
  ) {
    return __awaiter(
      this,
  ...
  HelperService.generateBlobUrl = function (
    path,
    blob,
    showHook,
    loading
  ...
  HelperService.generateThumbnail = function (
    videoUri,
    time
  ) {
    return __awaiter(
  ...
  HelperService.saveMedia = function (
    album,
    uri
  ) {
    return __awaiter(
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                MediaLibrary.getAlbumAsync(album)
              ]
            case 2:
              albumExists = _a.sent()
              if (!albumExists)
  ...
  HelperService.createDownload = function (
    id,
    uri,
    ext,
    callback
    ...
    var _this = this
    try {
      var hook = FileSystem.createDownloadResumable(
        uri,
  ...
  HelperService.startDownload = function (
    download
  ) {
    return __awaiter(
      this,
  ...
  HelperService.downloadFile = function (
    id,
    url,
    ext,
    callback
  ...
  HelperService.downloadCallback = function (
    progressInfo,
    callback
  ) {
    var totalBytesExpectedToWrite =
      ...
      totalBytesWritten =
        progressInfo.totalBytesWritten
    var progress =
      (totalBytesWritten /
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (
                result.action ===
                react_native_1.Share.sharedAction
              ) {
  ...
  HelperService.deleteMediaInfo = function (
    assets
  ) {
    return __awaiter(
      this,
  ...
  HelperService.parseToDate = function (val) {
    var diffDays = moment_1['default']().diff(
      val,
      'day'
    )
    var date =
