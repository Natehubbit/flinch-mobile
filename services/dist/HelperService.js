...
var HelperService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, ImagePicker.launchImageLibraryAsync(IMG_OPTIONS)];
                    case 2:
                        res = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, ImagePicker.requestCameraRollPermissionsAsync()];
                    case 1:
                        granted = (_a.sent()).granted;
                        if (!granted) return [3 /*break*/, 3];
                        return [4 /*yield*/, ImagePicker.launchImageLibraryAsync(VID_OPTIONS)];
                    case 2:
                        res = _a.sent();
                        if (res.cancelled === false) {
                            getVideo(res.uri);
    ...
    HelperService.createDownload = function (id, uri, ext, callback) {
        var _this = this;
        try {
            var hook = FileSystem.createDownloadResumable(uri, "" + FileSystem.cacheDirectory + ext, {}, function (progress) {
                return _this.downloadCallback(progress, callback);
            });
            var download = {
                id: id,
                hook: hook,
    ...
    HelperService.downloadCallback = function (progressInfo, callback) {
        ...
        var progress = (totalBytesWritten /
