...
var ResponseService = /** @class */ (function () {
    ...
    ResponseService.getApproved = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        snapshot = _a.sent();
                        return [2 /*return*/, snapshot.docs.map(function (d) { return (__assign({ id: d.id, celebrity: d.data().celebrity.name, recipient: d.data().recipient }, d.data().response)); })];
                    case 2:
                        e_1 = _a.sent();
