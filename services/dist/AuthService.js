...
var AuthService = /** @class */ (function () {
   ...
   */
  AuthService.authStateListener = function (
    onAuthChange
  ) {
    var subscriber = firebase_1.auth.onAuthStateChanged(
      onAuthChange
    )
    return subscriber
  }
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                firebase_1.auth.createUserWithEmailAndPassword(
                  email,
                  password
                )
              ]
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                firebase_1.auth.signInWithEmailAndPassword(
                  email,
                  password
                )
              ]
