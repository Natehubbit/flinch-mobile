...
var NotificationService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, NotificationsRef.doc(id).update(__assign({}, data))];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, NotificationsRef.where('recipientId', '==', id)
    ...
    NotificationService.listener = function (id, callback) {
        try {
            return NotificationsRef.where('recipientId', '==', id)
                .orderBy('createdAt', 'desc')
