...
export default class HelperService {
  ...
  static createDownload(
    ...
    try {
      const hook = FileSystem.createDownloadResumable(
        uri,
  ...
  static async deleteMediaInfo(
    assets: MediaLibrary.Asset[] | string[]
  ) {
    try {
      const deleted = await MediaLibrary.deleteAssetsAsync(
        assets
      )
      return deleted
    } catch (e) {
